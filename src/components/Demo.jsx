    ...
    return (
        <section className="mt-16 w-full max-w-xl">
            <div className="flex flex-col w-full gap-2">
                ...
                {allArticles?.length > 0 && <div className="flex justify-end" >
                    <Button setAllArticles={setAllArticles}>Clear History</Button>
                </div>}
                    ...
                    article.summary && (
                        <div className="flex flex-col gap-3" >
                            ...
                            <div className="summary_box">
                                <p
                                    className="font-inter font-medium text-base text-gray-700"
                                >{article.summary}</p>
                            </div>
