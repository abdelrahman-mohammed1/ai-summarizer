    ...
    return (
        ...
        '>
            <nav className="flex justify-between items-center w-full mb-10 pt-3">
                ...
                <button
                    type='button'
                    onClick={() => window.open('https://github.com/abdelrahman-mohammed1')}
                    className="black_btn flex items-center gap-2 px-4 py-2 rounded-lg"
                >

                    GitHub <FaGithubSquare style={{ fontSize: '20px' }} />
                </button>
            </nav>
